function mostrarConteudo(tipo) {
    ...
    if (tipo === "historia") {
        conteudo.innerHTML = `
            ...
            <p>Há momentos na vida de um motociclista em que a estrada à frente exige uma escolha: continuar seguindo um caminho que já não faz sentido ou ter a coragem de abrir uma nova trilha, essa escolha tornou-se inevitável.</p>
